...
<body>
    ...
    <div class="row mt-5">
        ...
        <div class="col-md-10 p-5 pt-5">
            ...
            <hr>
            <ul class="list-group">
                <li class="list-group-item"><img src="image/foto1.png<?= $dosenn['foto_maba']; ?>.png" width="400px"></li>
                ...
                <li class="list-group-item"><?= $dosenn['alamat']; ?></li>
                <li class="list-group-item"><?= $dosenn['agama']; ?></li>
                <li class="list-group-item"><?= $dosenn['sarjana1']; ?></li>
                <li class="list-group-item"><?= $dosenn['sarjana2']; ?></li>
                <li class="list-group-item"><?= $dosenn['sarjana3']; ?></li>
