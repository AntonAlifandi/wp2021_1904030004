...
$dosenn = query("SELECT * FROM daftar_dosen");
if (isset($_POST['caridosen'])) {
    $dosenn = caridosen($_POST['keyword']);
}
?>
    ...
    <div class="row mt-5">
        ...
        <div class="col-md-10 p-5 pt-5">
            ...
            <form action="" method="POST">
                ...
                <button type="submit" class="btn btn-primary" name="caridosen">CARI</button>
            </form>
            <br>
            <hr>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <?php $no = 1; ?>
                    <?php foreach ($dosenn as $dsn) : ?>
                        <tr>
                            <th scope="row"><?php echo $no; ?></th>
                            <td><?php echo $dsn['nidn']; ?></td>
                            <td><?php echo $dsn['nama']; ?></td>
                            <td><?php echo $dsn['email']; ?></td>
                            <td><a href="detaildsn.php?nidn=<?= $dsn['nidn']; ?>" class="btn btn-warning" role="button">Detail</a></td>
                        </tr>
                        <?php $no++ ?>
                    <?php endforeach ?>
                </tbody>
